...
class SaeTOAuthV2
{
    ...
    function getAccessToken ($type = 'code', $keys)
    {
        ...
        $response = $this->oAuthRequest($this->accessTokenURL(), 'POST', 
        $params);
        ...
        if (is_array($token) && ! isset($token['error'])) {
            ...
            "get access token failed." . $token['error']);
        }
        return $token;
    }
    /**
    ...
    function base64decode ($str)
    {
        ...
        strtr($str . str_repeat('=', (4 - strlen($str) % 4)), '-_', '+/'));
    }
    /**
...
class SaeTClientV2
{
    ...
    {
        $this->oauth = new SaeTOAuthV2($akey, $skey, $access_token, 
        $refresh_token);
    }
    /**
     * 获取最新的公共微博消息
     ...
     * @return array
     */
    function home_timeline ($page = 1, $count = 50, $since_id = 0, $max_id = 0, 
    $base_app = 0, $feature = 0)
    {
        $params = array();
        if ($since_id) {
     ...
     * @return array
     */
    function friends_timeline ($page = 1, $count = 50, $since_id = 0, $max_id = 0, 
    $base_app = 0, $feature = 0)
    {
        return $this->home_timeline($since_id, $max_id, $count, $page, 
        $base_app, $feature);
    }
    /**
     * 获取用户发布的微博信息列表
     ...
     * @return array
     */
    function user_timeline_by_name ($screen_name = NULL, $page = 1, $count = 50, 
    $since_id = 0, $max_id = 0, $feature = 0, $trim_user = 0, $base_app = 0)
    {
        $params = array();
     ...
     * @return array
     */
    function timeline_batch_by_name ($screen_name, $page = 1, $count = 50, 
    $feature = 0, $base_app = 0)
    {
        $params = array();
     ...
     * @return array
     */
    function timeline_batch_by_id ($uids, $page = 1, $count = 50, $feature = 0, 
    $base_app = 0)
    {
        $params = array();
     ...
     * @return array
     */
    function repost_timeline ($sid, $page = 1, $count = 50, $since_id = 0, 
    $max_id = 0, $filter_by_author = 0)
    {
        $this->id_format($sid);
        $params = array();
        $params['id'] = $sid;
        ...
        return $this->request_with_pager('statuses/repost_timeline', $page, 
        $count, $params);
    }
    /**
     * 获取当前用户最新转发的n条微博消息
    ...
    function repost_by_me ($page = 1, $count = 50, $since_id = 0, $max_id = 0)
    {
        ...
        return $this->request_with_pager('statuses/repost_by_me', $page, $count, 
        $params);
    }
    /**
     * 获取@当前用户的微博列表
     ...
     * @return array
     */
    function mentions ($page = 1, $count = 50, $since_id = 0, $max_id = 0, 
    $filter_by_author = 0, $filter_by_source = 0, $filter_by_type = 0)
    {
        ...
        return $this->request_with_pager('statuses/mentions', $page, $count, 
        $params);
    }
    /**
     * 根据ID获取单条微博信息内容
     ...
     * @return array
     */
    function get_comments_by_sid ($sid, $page = 1, $count = 50, $since_id = 0, 
    $max_id = 0, $filter_by_author = 0)
    {
        $params = array();
        $this->id_format($sid);
     ...
     * @return array
     */
    function comments_by_me ($page = 1, $count = 50, $since_id = 0, $max_id = 0, 
    $filter_by_source = 0)
    {
        $params = array();
        if ($since_id) {
     ...
     * @return array
     */
    function comments_to_me ($page = 1, $count = 50, $since_id = 0, $max_id = 0, 
    $filter_by_author = 0, $filter_by_source = 0)
    {
        $params = array();
        if ($since_id) {
            $this->id_format($since_id);
    ...
    function comments_timeline ($page = 1, $count = 50, $since_id = 0, $max_id = 0)
    {
        ...
        return $this->request_with_pager('comments/timeline', $page, $count, 
        $params);
    }
    /**
     ...
     * @return array
     */
    function comments_mentions ($page = 1, $count = 50, $since_id = 0, $max_id = 0, 
    $filter_by_author = 0, $filter_by_source = 0)
    {
        $params = array();
        $params['since_id'] = $since_id;
    ...
    function list_dm ($page = 1, $count = 50, $since_id = 0, $max_id = 0)
    {
        ...
        return $this->request_with_pager('direct_messages', $page, $count, 
        $params);
    }
    /**
     * 获取当前用户发送的最新私信列表
    ...
    function list_dm_sent ($page = 1, $count = 50, $since_id = 0, $max_id = 0)
    {
        ...
        return $this->request_with_pager('direct_messages/sent', $page, $count, 
        $params);
    }
    /**
     ...
     * @return array
     */
    function dm_conversation ($uid, $page = 1, $count = 50, $since_id = 0, 
    $max_id = 0)
    {
        $params = array();
        $this->id_format($uid);
    ...
    $count = false, $cursor = false, $post = false, $params = array())
    {
        if ($page)
            $params['page'] = $page;
        if ($count)
