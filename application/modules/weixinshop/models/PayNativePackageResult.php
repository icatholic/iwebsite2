...
class Weixinshop_Model_PayNativePackageResult extends iWebsite_Plugin_Mongo
{
     ...
     * 记录
     */
    public function log($AppId, $OpenId, $IsSubscribe, $ProductId, $TimeStamp, $NonceStr, $AppSignature, $SignMethod, $PostData, $RetCode = 0, $RetErrMsg = "ok", $out_trade_no = "", $Package = "", $result = "", $calc_appSignature = "")
    {
        $data = array();
        // 公众帐号的appid
        $data['AppId'] = $AppId;
