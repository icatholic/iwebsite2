...
class Weixinshop_Model_PayNotifyResult extends iWebsite_Plugin_Mongo {
	 ...
	 */
	public function handle($sign_type, $service_version, $input_charset, $sign, $sign_key_index, $trade_mode, $trade_state, $pay_info, $partner, $bank_type, $bank_billno, $total_fee, $fee_type, $notify_id, $transaction_id, $out_trade_no, $attach, $time_end, $transport_fee, $product_fee, $discount, $buyer_alias, array $PostData, $postStr, array $notify_result, $calc_sign = "", $calc_appSignature = "") {
		$data = array ();
		// 协议参数
