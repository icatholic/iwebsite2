...
ColorSelecter.Show = function(sender,method)
{
	if(ColorSelecter.box)
	{
		if (ColorSelecter.box.style.display = "none") ColorSelecter.box.style.display = "";
	}
	else
	{
		...
		var cancel_color_tr = "";
		if(typeof(cancel_color)!='undefined')
		{
			cancel_color_tr = "<tr>" +
			  					"<td align='center' colspan='5'><font style='cursor:default'>" + cancel_color + "</font></td>" +
		  						"</tr>";
		}
		
		var table = "<table width='93' border='1' cellpadding='0' cellspacing='0' bordercolor='#BDBBBC' style='border:2px #C5D9FE solid'>" +
		    		"<tr>" +
		    		...
		    		"</tr>" +
		    		"<tr>" +
		    		"<td bgcolor='#CC99FE'>&nbsp;</td>" +
		    		"<td bgcolor='#993365'>&nbsp;</td>" +
		    		"<td bgcolor='#81007F'>&nbsp;</td>" +
		    		"<td bgcolor='#6766CC'>&nbsp;</td>" +
		    		"<td bgcolor='#343399'>&nbsp;</td>" +
		    		"</tr>" +
		    		"<tr>" +
		    		...
		    		"<td bgcolor='#010080'>&nbsp;</td>" +
		    		"</tr>" +
		    		"<tr>" +
		    		"<td bgcolor='#CDFFFF'>&nbsp;</td>" +
		    		"<td bgcolor='#01FFFF'>&nbsp;</td>" +
		    		"<td bgcolor='#33CBCC'>&nbsp;</td>" +
		    		"<td bgcolor='#008081'>&nbsp;</td>" +
		    		"<td bgcolor='#003265'>&nbsp;</td>" +
		    		"</tr>" +
		    		"<tr>" +
		    		"<td bgcolor='#CDFFCC'>&nbsp;</td>" +
		    		"<td bgcolor='#00FF01'>&nbsp;</td>" +
		    		"<td bgcolor='#339967'>&nbsp;</td>" +
		    		"<td bgcolor='#008002'>&nbsp;</td>" +
		    		"<td bgcolor='#013300'>&nbsp;</td>" +
		    		"</tr>" +
		    		"<tr>" +
		    		"<td bgcolor='#FFFE99'>&nbsp;</td>" +
		    		"<td bgcolor='#FFFE03'>&nbsp;</td>" +
		    		"<td bgcolor='#99CD00'>&nbsp;</td>" +
		    		"<td bgcolor='#807F01'>&nbsp;</td>" +
		    		"<td bgcolor='#333301'>&nbsp;</td>" +
		    		"</tr>" +
		    		"<tr>" +
		    		"<td bgcolor='#FFCB99'>&nbsp;</td>" +
		    		"<td bgcolor='#FFCD00'>&nbsp;</td>" +
		    		"<td bgcolor='#FF9900'>&nbsp;</td>" +
		    		"<td bgcolor='#FD6600'>&nbsp;</td>" +
		    		"<td bgcolor='#993400'>&nbsp;</td>" +
		    		"</tr>" +
		    		"<tr>" +
		    		"<td bgcolor='#FF99CB'>&nbsp;</td>" +
